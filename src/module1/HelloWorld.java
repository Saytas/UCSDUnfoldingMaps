...
public class HelloWorld extends PApplet
{
	...
	public void setup() {
		...
		map1 = new UnfoldingMap(this, 50, 50, mapWidth, mapHeight, provider);
		...
		map2 = new UnfoldingMap(this, 50, 50, mapWidth, mapHeight, provider2);
		map2.zoomAndPanTo(zoomLevel, new Location(41.00, 28.87));
