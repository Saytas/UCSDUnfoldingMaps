...
public class EarthquakeCityMap extends PApplet {
	...
	public void setup() {
	    ...
	    if (earthquakes.size() > 0) {
	    	PointFeature pntFeature = earthquakes.get(0);
	    	System.out.println(pntFeature.getProperties());
	    	
	    	for (PointFeature pntFtr : earthquakes) {
	    		markers.add(createMarker(pntFtr));
	    	}
